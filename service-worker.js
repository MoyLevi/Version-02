...
const APP_SHELL = [
  ...
  "./version.json",
  "./favicon.png",
  "./css/base.css?v=4.2.5",
  "./css/layout.css?v=4.2.5",
  "./css/components.css?v=4.2.5",
  "./css/responsive.css?v=4.2.5",
  "./js/config.js?v=4.2.5",
  "./js/data.js?v=4.2.5",
  "./js/utils.js?v=4.2.5",
  "./js/scoring.js?v=4.2.5",
  "./js/views-inicio.js?v=4.2.5",
  "./js/views-partidos.js?v=4.2.5",
  "./js/views-tabla.js?v=4.2.5",
  "./js/views-stats.js?v=4.2.5",
  "./js/app.js?v=4.2.5",
  "./js/firebase.js?v=4.2.5",
  "./js/pwa.js?v=4.2.5",
  "./js/notifications.js?v=4.2.5",
  "./img/copa-fifa.png",
