...
const APP_SHELL = [
  ...
  "./version.json",
  "./favicon.png",
  "./css/base.css?v=4.2.7",
  "./css/layout.css?v=4.2.7",
  "./css/components.css?v=4.2.7",
  "./css/responsive.css?v=4.2.7",
  "./js/config.js?v=4.2.7",
  "./js/data.js?v=4.2.7",
  "./js/utils.js?v=4.2.7",
  "./js/scoring.js?v=4.2.7",
  "./js/views-inicio.js?v=4.2.7",
  "./js/views-partidos.js?v=4.2.7",
  "./js/views-tabla.js?v=4.2.7",
  "./js/views-stats.js?v=4.2.7",
  "./js/app.js?v=4.2.7",
  "./js/firebase.js?v=4.2.7",
  "./js/pwa.js?v=4.2.7",
  "./js/notifications.js?v=4.2.7",
  "./img/copa-fifa.png",
