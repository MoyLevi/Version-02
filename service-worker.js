...
const APP_SHELL = [
  ...
  "./version.json",
  "./favicon.png",
  "./css/base.css?v=4.2.6",
  "./css/layout.css?v=4.2.6",
  "./css/components.css?v=4.2.6",
  "./css/responsive.css?v=4.2.6",
  "./js/config.js?v=4.2.6",
  "./js/data.js?v=4.2.6",
  "./js/utils.js?v=4.2.6",
  "./js/scoring.js?v=4.2.6",
  "./js/views-inicio.js?v=4.2.6",
  "./js/views-partidos.js?v=4.2.6",
  "./js/views-tabla.js?v=4.2.6",
  "./js/views-stats.js?v=4.2.6",
  "./js/app.js?v=4.2.6",
  "./js/firebase.js?v=4.2.6",
  "./js/pwa.js?v=4.2.6",
  "./js/notifications.js?v=4.2.6",
  "./img/copa-fifa.png",
