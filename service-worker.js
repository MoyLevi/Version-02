...
const APP_SHELL = [
  ...
  "./version.json",
  "./favicon.png",
  "./css/base.css?v=4.2.4",
  "./css/layout.css?v=4.2.4",
  "./css/components.css?v=4.2.4",
  "./css/responsive.css?v=4.2.4",
  "./js/config.js?v=4.2.4",
  "./js/data.js?v=4.2.4",
  "./js/utils.js?v=4.2.4",
  "./js/scoring.js?v=4.2.4",
  "./js/views-inicio.js?v=4.2.4",
  "./js/views-partidos.js?v=4.2.4",
  "./js/views-tabla.js?v=4.2.4",
  "./js/views-stats.js?v=4.2.4",
  "./js/app.js?v=4.2.4",
  "./js/firebase.js?v=4.2.4",
  "./js/pwa.js?v=4.2.4",
  "./js/notifications.js?v=4.2.4",
  "./img/copa-fifa.png",
