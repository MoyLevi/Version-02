...
const APP_SHELL = [
  ...
  "./version.json",
  "./favicon.png",
  "./css/base.css?v=4.2.3",
  "./css/layout.css?v=4.2.3",
  "./css/components.css?v=4.2.3",
  "./css/responsive.css?v=4.2.3",
  "./js/config.js?v=4.2.3",
  "./js/data.js?v=4.2.3",
  "./js/utils.js?v=4.2.3",
  "./js/scoring.js?v=4.2.3",
  "./js/views-inicio.js?v=4.2.3",
  "./js/views-partidos.js?v=4.2.3",
  "./js/views-tabla.js?v=4.2.3",
  "./js/views-stats.js?v=4.2.3",
  "./js/app.js?v=4.2.3",
  "./js/firebase.js?v=4.2.3",
  "./js/pwa.js?v=4.2.3",
  "./js/notifications.js?v=4.2.3",
  "./img/copa-fifa.png",
